...
type ConferenceRoomsFeaturesProps = ConferenceRoomsFeaturesStore.FeaturesState &
  Swipeable.SwipeableProps &
  typeof ConferenceRoomsFeaturesStore.actionCreators;

class ConferenceRoomsFeatures extends React.Component<
  ConferenceRoomsFeaturesProps,
  {}
> {
  ...
  private renderRoomInCarousel(feature: any, key: any) {
    return (
      <li
        key={key}
        className={
          'sh-rooms_feature-wrapper ' + (feature.title ? '' : 'is-invisible')
        }
      >
        <div
          className='sh-rooms_feature-image'
          style={this.setBackgroundImage(feature.imageUrl)}
        />
  ...
  public render() {
    return (
      <div className='sh-rooms_feature'>
        <span
          className='sh-rooms_feature-arrow icon-sh-chevron'
          onClick={this.onSwipedRight}
        />
        <span
          className='sh-rooms_feature-arrow sh-rooms_feature-arrow--right icon-sh-chevron'
        ...
        >
          <div className='sh-rooms_feature-carousel'>
            <ul
              className='sh-rooms_feature-slider'
              style={this.props.translation.styles}
            >
        ...
        <button className='sh-rooms_feature-button btn'>
